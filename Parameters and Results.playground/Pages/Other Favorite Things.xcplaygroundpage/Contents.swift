 ...
 */
func categoria (objeto: String, favorito: String)
{ print("Meu \(objeto) é \(favorito)") }

categoria(objeto: "carro", favorito: "é bmw")
categoria(objeto: "celular", favorito: "é iphone")
/*:
