...
let name = "Cassiane and Alan"
let number = "$100000"
let adjective = "White BMW"
let noun = "Car"
let place = "Shop Car"
let positiveEmotion = "excitement"
let negativeEmotion = " sadness"

"Today was a big day for \(name). They had finally saved up \(number) dollars and were going to buy a \(adjective). They went to the \(place) feeling very \(positiveEmotion). But then they felt \(negativeEmotion). They saw tha the \(place) was closed."
/*:
