 ...
 */
let adjective = "sustentavel "
let adjective1 = "velho"
let noun =  "ios, android, cadeira"
let number = "2020"
let pluralNoun = "interface aplicativos"

"Você pode saber o que disse, mas nunca o que o outro escutou."
var frase = "Você pode \(adjective)saber \(noun) disse, mas \(number) o que \(pluralNoun) \(adjective1) escutou."
