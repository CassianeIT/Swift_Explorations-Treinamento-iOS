...
let converterLetra = question.lowercased()
    
// para fazer de forma otimizada seria, apagar linha 27 e substituir linha 29 por: if converterLetra.lowercased().hasPrefix("Hello!") {
    if converterLetra.hasPrefix("hello") {
        return "E ai, beleza"
    } else {
        return "Putz, ai depende"
  }
}
