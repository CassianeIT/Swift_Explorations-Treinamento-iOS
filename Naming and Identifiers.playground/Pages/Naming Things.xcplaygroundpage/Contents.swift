 ...
 */
var numberOfDogs = 6
let numberOfDogsAdded = 2
let numberOfDogsAbsent = 0
numberOfDogs += numberOfDogsAdded - numberOfDogsAbsent

var numberOfCats = 5
let numberOfCatsAdded = 0
let numberOfCatsAbsent = 1
numberOfCats += numberOfCatsAdded - numberOfCatsAbsent

var numberOfTurtles = 2
let numberOfTurtlesAdded = 1
let numberOfTurtlesAbsent = 0
numberOfTurtles += numberOfTurtlesAdded - numberOfTurtlesAbsent

var numberOfHamsters = 1
let numberOfHamstersAdded = 1
let numberOfHamstersAbsent = 0
numberOfHamsters += numberOfHamstersAdded - numberOfHamstersAbsent
